...
The consolidated calculation reference contains **61 documented calculation entries** covering measures, calculated columns and calculated tables — see [`Olist_All_DAX_Measures_Columns_Tables.docx`](./Documentation/Olist_All_DAX_Measures_Columns_Tables.docx).
